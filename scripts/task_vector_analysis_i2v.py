"""
Task Vector Analysis: Wan 2.1 I2V -> Wan 2.2 I2V Expert Divergence
...
BASE_MODEL = Path(r"C:\Users\minta\Projects\dimljus\models\Wan2.1-I2V-14B-720P-Diffusers\transformer")
HIGH_NOISE = Path(r"C:\Users\minta\Projects\dimljus\models\Wan2.2-I2V-A14B-Diffusers\transformer")
LOW_NOISE = Path(r"C:\Users\minta\Projects\dimljus\models\Wan2.2-I2V-A14B-Diffusers\transformer_2")
...
def main():
    print("=" * 80)
    print("TASK VECTOR ANALYSIS: Wan 2.1 I2V -> Wan 2.2 I2V Expert Specialization")
    print("=" * 80)
    print()
    ...
    # ── Analyze each layer ────────────────────────────────────────────
    print("Analyzing layers (this processes ~80GB across 3 I2V models of weights, may take a few minutes)...")
    print()
    ...
    print("=" * 80)
    print()
    print("  High%  = how far the high-noise expert moved from Wan 2.1 I2V (avg relative magnitude)")
    print("  Low%   = how far the low-noise expert moved from Wan 2.1 I2V")
    ...
    print()
    print("  LEAST MOVED blocks (stayed closest to Wan 2.1 I2V):")
    ...
    print()
    print("  MOST MOVED blocks (changed the most from Wan 2.1 I2V):")
    for block_idx, tv_cos, h_mag, l_mag in block_by_movement[-5:]:
        print(f"    Block {block_idx:>2}: high moved {h_mag:.2f}%, low moved {l_mag:.2f}%, TV cosine = {tv_cos:.4f}")
    ...
    print()
    print("=" * 80)
    print("TRAINING STRATEGY IMPLICATIONS (I2V)")
    print("=" * 80)
    print()
    ...
    output_path = Path(__file__).parent / "task_vector_results_i2v.json"
